<?php
$pages = ["novedades", "multimedia", "categorias"];
?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown <?php if (!in_array('multimedia', $pages)) {echo 'd-none';}?>">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?=URL?>/index.php?op=novedades&accion=ver">Novedades</a>
                        <a class="dropdown-item" href="<?=URL?>/index.php?op=banners&accion=ver">Banners</a>
                    </div>
                </li>
